...
class FCG(): ##/////////////Changed for testing/////////////////////
    ...
    def build_fcg(self):
        ...
        """
        # fcg = self.dx.get_call_graph() ##//////////Original////////////
        ...
        for n in fcg.nodes:
            ...
            try:
                ...
                encoded_label = np.array([0] * 15) ## changed b/c external method don't have instructions
                # encoded_label = np.array2string(np.zeros(len(INSTRUCTION_CLASSES),
                #                                              dtype=np.int8)) ##////////Orignal
                # print("In Exception")
...
# class FCG():
class WakeFCG(): ##////Changed for testing
